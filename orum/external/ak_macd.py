...
0rum still DECIDES whether to act; this module only PROPOSES a candidate.
...
Faithful recreation of pine/ak_macd_15m.pine (dotMode="slope", EMA baseline):
  ...
  volume   > SMA(volume, 9)
  SL/TP frozen by 0rum' bracket.py (widest of baseline/swing, TP = 1.5R).
"""
...
from orum.dsl import indicators as ind
