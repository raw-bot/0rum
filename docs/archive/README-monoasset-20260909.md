# Archive du README mono-actif — 9 septembre 2026

> Document historique conservé pour comprendre les anciens résultats. Les commandes,
> modes et limites ci-dessous ne décrivent pas le service actuel. Ne pas les appliquer
> au portefeuille courant. Voir [modes opérationnels](../OPERATING-MODES.md).
...
specified. See [docs/llm-trading-lab.md](../llm-trading-lab.md) for the full
