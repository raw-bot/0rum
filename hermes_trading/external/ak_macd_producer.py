...
(hermes_trading.external.ak_macd) and routes any confirmed candidate through the
...
from hermes_trading.external.signal import ExternalSignalError, parse_external_signal
from hermes_trading.external.validate import ValidationContext, validate_external_signal
from hermes_trading.paths import GOAL_PATH, STATE_DIR, STRATEGY_PATH
...
class AkMacdProducer:
    ...
    def _shadow_detail(self, payload: dict) -> str:
        """In shadow, report whether the payload WOULD pass Hermes' gates."""
        try:
