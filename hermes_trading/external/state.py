...
from hermes_trading.loop import POSITION_PATH, RESUME_ACK_PATH, _load_open_position
from hermes_trading.paths import STRATEGY_PATH, TRADES_PATH
...
class LiveStateAccess:
    ...
    def trading_mode(self) -> str:
        return os.getenv("HERMES_TRADING_MODE", "paper")
