...
Hermes considers acting on it, the payload must be parsed into a well-typed,
...
class ExternalSignalStatus(str, Enum):
    """Lifecycle of an external signal once Hermes owns it.
...
class ExternalSignal:
    ...
    the original payload verbatim for audit; `received_at` is when Hermes saw
    it (not the bar time).
    """
