"""Phase 3: business validation of an external signal against Hermes' own gates.

This is the layer that enforces the architecture rule: TradingView may *propose*
a signal, but Hermes decides. Every check below is a reason Hermes can refuse,
...
from hermes_trading.loop import guardrail_action
