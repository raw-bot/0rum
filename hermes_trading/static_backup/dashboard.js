...
const layoutStorageKey = "hermes-dashboard-window-layout-v1";
...
async function loadState() {
  ...
  setText("engineStatus", `${engine.label || "Fallback only"} · ${engine.detail || "Hermes inactive"}`);
...
document.getElementById("reflectButton").addEventListener("click", async () => {
  ...
  try {
    ...
    button.textContent = "Run Hermes reflection";
  }
});
